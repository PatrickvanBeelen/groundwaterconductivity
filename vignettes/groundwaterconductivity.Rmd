...
The calculations will be performed. You can replace data/input_groundwaterconductivity.rda with your own data.
...
The data input results in a standard broad LMM style input file like data/Table_Stuyfzand_LMM_broad_input_groundwaterconductivity.rds It has all the necessary input parameters mentioned in table 1. This makes it possible to check whether the input parameters are correct.
