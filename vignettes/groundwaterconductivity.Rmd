...
Whereas the README.Rds file gives you information about what you can do with the groundwaterconductivity package. This manual will show you how to do it. The method is described in a Dutch report by Stuyfzand, P. (1987). Een zeer nauwkeurige berekening van het elektrisch geleidingsvermogen, ter controle en aanvulling van wateranalyses: 2e versie. Rijswijk, KIWA. Table 3.1 of this report is used to test the calculations. The table 3.1 is shown in data/input_dataframe.rda
...
The data input results in a standard broad LMM style input file like data/Table_Stuyfzand_LMM_broad_input_dataframe.rds It has all the necessary input parameters mentioned in table 1. This makes it possible to check whether the input parameters are correct.
